    ...
    >
      ...
      >
          ...
          <Accordion.Item label="What is Poverty?">
            <SimpleGrid cols={3}>
              <Image src="/image4.jpeg" width="600" height="400" className="rounded-lg" alt="" />
          ...
          <SimpleGrid cols={3}>
            <Image src="/image5.jpeg" width="500" height="500" className="rounded-lg" alt="" />
          ...
          <Accordion.Item label="What is the main cause of poverty?">
            <SimpleGrid cols={3}>
              <Image src="/image6.jpeg" width="500" height="500" className="rounded-lg" alt="" />
      ...
      <Accordion.Item label="Cause Inequality">
        <SimpleGrid cols={3}>
          <Image src="/image7.jpeg" width="300" height="350" className="rounded-lg" alt="" />
      ...
      <Accordion.Item label="Cause Wars">
        <SimpleGrid cols={3}>
        <Image src="/image8.jpeg" width="300" height="350" className="rounded-lg" alt="" />  
      ...
      <Accordion.Item label="Cause Migration Issues">
        <SimpleGrid cols={3}>
          <Image src="/image9.jpeg" width="300" height="350" className="rounded-lg" alt="" />  
      ...
      <Accordion.Item label="Cause Unemployment">
        <SimpleGrid cols={3}>
          <Image src="/image10.jpeg" width="300" height="350" className="rounded-lg" alt="" />  
      ...
      <Tabs.Tab label="2 Inspiring People">
        <SimpleGrid cols={2}>
          ...
          <Image src="/image1.jpeg" width="300" height="450" alt="" />
        </SimpleGrid>
        <br /><hr /><br />
        <SimpleGrid cols={2}>
          <div>
